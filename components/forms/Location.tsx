    ...
    <>
      ...
      >
        ...
        <div
          ...
          } flex justify-center items-center md:border-0 md:text-primary-500 md:bg-transparent px-6 md:px-0 rounded-full overflow-hidden max-w-lg`}
        >
        ...
        <>
          <div className="flex flex-col md:max-w-[34rem] md:h-fit rounded-t-2xl md:rounded-2xl py-5 md:pb-4 px-4 gap-4 bg-white w-full h-96 absolute bottom-0 md:top-0 md:m-auto md:right-0 md:left-0 z-50 animate-[locationIn_0.3s_ease]">
            ...
            <div className=" relative">
              <div
                className={`flex justify-center items-center p-0 m-0 w-full hover:border-2 hover:border-primary-500 transition-color duration-100 bg-white border-2 border-gray-300 h-12 px-3 rounded-xl`}
              >
                <input
